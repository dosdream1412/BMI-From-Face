...
print(start_time)
DATASET_PATH  = './detec_train/img'
IMAGE_SIZE    = (224, 224)
NUM_CLASSES   = 5  #edit
BATCH_SIZE    = 40  # try reducing batch size or freeze more layers if your GPU runs out of memory
FREEZE_LAYERS = 5  #edit # freeze the first this many layers for training
NUM_EPOCHS    = 200
WEIGHTS_FINAL = 'model-resnet50-final.h5'
csv_logger = CSVLogger('log.csv', append=True, separator=';') #add log to csv file
...
print('start_time : ',start_time,' end_time : ',datetime.datetime.now())
